...
const SideBarComponent = () => {
  return (
    <div className="w-2/12 bg-red-500  flex bg-white">
      <div className="w-full justify-center">
        <div className="px-5 pt-4 flex">
          <div className="text-white bg-green my-8 text-xs font-bold py-2 px-5 rounded-2xl">
            GENERATE INVOICE
          </div>
        </div>

        <div className="px-5 py-4 flex">
          <div className="text-secondary text-xs ml-0">main</div>
        </div>
        <TileComponent
          icon={
            <svg
        ...
        <div className="px-5 py-4 flex mt-8">
          <div className="text-secondary text-xs ml-0">Payments</div>
        </div>
        <TileComponent
          icon={
            <svg
